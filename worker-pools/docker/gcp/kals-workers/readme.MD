...
| `spacelift_api_key_id` | `<create key on spacelift account>` | Environment | Yes ✅ |
| `spacelift_api_key_secret` | `<copy from key secret once you create your key>` | Environment | Yes ✅ |
